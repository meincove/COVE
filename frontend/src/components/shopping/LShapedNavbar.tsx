...
export default function LShapedNavbar({
    ...
    // surface used across header + rail + main content
    const surfaceClass =
    ...
    return (
        ...
        >
            ...
            <div className="sticky top-0 z-50">
                <div
                    // Gradient behind header = blends with hero fade (no “hard line” feeling)
                ...
                >
                    ...
                    {/* small spacer still using header background */}
            ...
            >
                ...
                >
                    ...
                    {/* Main content: now also a surface (prevents “bleed” + feels inside frame) */}
                    <div className="min-w-0">
                        <div
                            className={cn(
                                surfaceClass,
                                "border border-black/10 rounded-[28px] overflow-hidden"
                            )}
                        >
                            {children}
                        </div>
            ...
            <AnimatePresence>
                {hoveredFilter && hoveredRect && (
                    <FlyoutMenu
                        ...
                        onSelect={(opt) => {
                            if (hoveredFilter) onFilterChange?.(hoveredFilter, opt)
                        }}
    ...
    return (
        ...
        >
            <div className="flex flex-col items-center leading-tight">
                ...
                {isActive && (
                    <span className="text-[9px] opacity-60 font-normal">({selectedCount})</span>
                )}
            </div>
            {isActive && (
...
// type CSSLen = string // e.g. "76px" OR "clamp(3rem, 5vw, 5rem)"

// type LShapedNavbarProps = {
//     className?: string

//     // NEW: mount navbar inside a container (sheet) instead of viewport
//     position?: "fixed" | "absolute"

//     // NEW: string-based sizing (responsive)
//     topHeight?: CSSLen
//     railWidth?: CSSLen
//     edgeGap?: CSSLen
//     rightCut?: CSSLen

//     // Back-compat (optional): old px/vw numbers
//     topHeightPx?: number
//     railWidthPx?: number
//     edgeGapPx?: number
//     rightCutVW?: number
...
//     // responsive string props (preferred)
//     topHeight,
//     railWidth,
//     edgeGap,
//     rightCut,

//     // legacy numeric props (fallback)
//     topHeightPx = 76,
//     railWidthPx = 112,
//     edgeGapPx = 18,
//     rightCutVW = 10,
...
//     const rootPosClass = position === "fixed" ? "fixed" : "absolute"

//     // compute CSS var values
//     const navGap = edgeGap ?? `${edgeGapPx}px`
//     const topH = topHeight ?? `${topHeightPx}px`
//     const railW = railWidth ?? `${railWidthPx}px`
//     const rightC = rightCut ?? `${rightCutVW}vw`

//     return (
//         <div
//             className={cn("pointer-events-none inset-0 z-40 font-sans", rootPosClass, className)}
//             style={
//                 {
//                     ["--nav-gap" as any]: navGap,
//                     ["--top-h" as any]: topH,
//                     ["--rail-w" as any]: railW,
//                     ["--right-cut" as any]: rightC,
//                 } as React.CSSProperties
//             }
//         >
//             {/* TOP BAR (now absolute within root) */}
//             <header
//                 className={cn(
//                     "pointer-events-auto absolute",
//                     surfaceClass,
//                     "border-t border-b border-r border-black/10",
//                     "rounded-tr-[28px] rounded-br-[28px]"
//                 )}
//                 style={{
//                     top: "var(--nav-gap)",
//                     left: "calc(var(--nav-gap) + var(--rail-w))",
...
//             {/* LEFT RAIL (absolute within root) */}
//             <aside
//                 className={cn(
//                     "pointer-events-auto absolute flex flex-col",
//                     surfaceClass,
//                     "border-l border-b border-r border-black/10",
//                     "rounded-bl-[28px] rounded-br-[28px]"
//                 )}
//                 style={{
//                     top: "calc(var(--nav-gap) + var(--top-h))",
//                     bottom: "var(--nav-gap)",
//                     left: "var(--nav-gap)",
//                     width: "var(--rail-w)",
//                     borderTop: "none",
...
//             {/* CORNER CONNECTOR (absolute within root) */}
//             <div
//                 className={cn(
...
//             {/* Flyout stays fixed (viewport-based) */}
//             <AnimatePresence>
//                 {hoveredFilter && hoveredRect && (
//                     <FlyoutMenu
//                         group={filterGroups.find((g) => g.label === hoveredFilter)!}
...
//     // ✅ Content rendered to the right of the left rail
//     children: React.ReactNode
// }
...
// }: LShapedNavbarProps) {
//     const surfaceClass =
//         "bg-white/70 backdrop-blur-xl shadow-[0_18px_55px_rgba(0,0,0,0.18)]"
...
//     // ✅ sticky offset for left rail (below the sticky header row)
//     const railStickyTop = `calc(var(--nav-gap) * 2 + var(--top-h))`
...
//             }
//         >
//             {/* ✅ STICKY HEADER ROW (part of flow) */}
//             <div className="sticky top-0 z-50">
//                 <div
//                     className="w-full"
//                     style={{
...
//             {/* ✅ BODY GRID: left rail + main content */}
//             <div
//                 className="w-full"
//                 style={{
//                     paddingLeft: "var(--nav-gap)",
